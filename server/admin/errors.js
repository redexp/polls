...
/**
 * Помилки адмінки — це кинуті обʼєкти з полем type. Усе інше летить далі, до
 * загального обробника: невідома помилка не мусить виглядати як відмова форми.
 *
 * @type {import('express').ErrorRequestHandler}
 */
export function errorHandler(err, _req, res, next) {
	const message = MESSAGES.get(err?.type);
